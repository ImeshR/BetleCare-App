  ...
  final Map<String, Map<String, dynamic>> _diseaseInfo = {
    'Bacterial leaf blight': {
      ...
      'treatments': [
        ...
        'සෑම උදෑසනකම හෝ සවසකම Copper Oxychloride හෝ Copper Hydroxide නියමිත ප්‍රමාණයට මිශ්‍ර කර කොල වල හොඳින් තවරන්න (දින 7කට වරක්) /n (මිශ්‍රණය: Copper Oxychloride හෝ Copper Hydroxide ග්‍රෑ.3-4ක් වතුර ලීටර් 1කට)'
      ],
      'color': Colors.orange,
      'icon': Icons.grass,
    },
    'Brown Spots': {
      ...
      'treatments': [
        ...
        'සෑම උදෑසනකම හෝ සවස් කාලයේ Mancozeb දිලීර නාශක‍ය නියමිත ප්‍රමාණයට මිශ්‍රකර ආසාදනය වූ කොල වලට හොඳින් ඉසින්න (දින 10 කට වරක්) /n (මිශ්‍රණය: Mancozeb ග්‍රෑ. 2-3ක් වතුර ලීටර් 1කට_',
    ...
    'Firefly disease': {
      ...
      'treatments': [
        ...
        'සෑම උදෑසනකම හෝ සවස් කාලයේ Chlorpyrifos හෝ Imidacloprid නියමිත ප්‍රමාණයට මිශ්‍ර කර කොල වල හොඳින් තවරන්න (දින 5කට වරක්) /n (මිශ්‍රණය: Chlorpyrifos මි.ලී 2.5ක් වතුර ලිට‍ර් 1කට / Imidacloprid මි.ලී 0.5ක් වතුර ලීටර් 1කට)',
    ...
    'Red spider mite': {
      ...
      'treatments': [
        'කොහොඹ තෙල් සබන් මිශ්‍රණය දින 10ක් යනතුරු කොල වලට යොදන්න /n (මිශ්‍රණය: කොහොඹ තෙල් මි.ලී 5ක් හා සබන් මි.ලී 2ක් වතුර ලීටර් 1කට).',
