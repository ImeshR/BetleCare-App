    ...
    if (_validateForm()) {
      try {
        ...
        final updatedBed = BetelBed(
          ...
          imageUrl: _existingImagePath ?? '',  // Will be updated if new image is uploaded
        ...
        if (_imageFile != null) {
          ...
          final updatedBedWithImage = await _betelBedService.updateBedWithImage(updatedBed, _imageFile!);
